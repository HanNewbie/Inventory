                ...
                <tbody>
                    @forelse ($admins as $adm)
                        <tr class="border-b">
                            ...
                            <td class="p-3 text-center align-middle">{{ $adm->id }}</td>
                            <td class="p-3 text-left align-middle">{{ $adm->username }}</td>
                            <td class="p-3 text-left align-middle">{{ $adm->role }}</td>
                            ...
                            <td class="p-3 text-center align-middle">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <form id="delete-form-{{ $adm->id }}" method="POST" action="">
                                        @csrf
                                        @method('DELETE')
                                        <button 
                                            type="button" 
