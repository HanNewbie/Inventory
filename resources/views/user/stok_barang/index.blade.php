...
@section('content')
    <main class="p-6 bg-gray-50 min-h-screen flex-1" x-data="{
        ...
        <div class="bg-white shadow-lg rounded-2xl overflow-hidden">
            <div
                class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 px-6 py-4 border-b border-gray-100 bg-gradient-to-r">
                <h3 class="text-2xl font-semibold text-gray-800">📦 Stok Barang BLUD</h3>
                <form action="" method="GET" class="flex flex-wrap sm:flex-nowrap items-center gap-2 w-full sm:w-auto">

                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari barang..."
                        class="w-full sm:w-72
               border border-gray-300
               focus:border-blue-500 focus:ring-2 focus:ring-blue-200
               outline-none px-4 py-2 rounded-lg transition-all">
