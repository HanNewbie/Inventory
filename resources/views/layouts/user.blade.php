    ...
    <div class="flex flex-col min-h-screen">
        <header class="bg-white shadow-md p-4 flex justify-between items-center">
            <div class="flex items-center gap-3">
                <button class="lg:hidden p-2 rounded-md border border-gray-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        aria-label="Toggle menu" @click="sidebarOpen = !sidebarOpen" :class="{ 'hamburger-active': sidebarOpen }">
        ...
        <div x-cloak x-show="sidebarOpen" x-transition.opacity
             class="fixed inset-x-0 top-16 bottom-0 bg-black bg-opacity-30 z-40 lg:hidden"
             @click="sidebarOpen = false" @keyup.escape.window="sidebarOpen = false"></div>
